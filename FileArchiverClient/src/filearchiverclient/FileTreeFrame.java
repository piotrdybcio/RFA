...
public class FileTreeFrame extends JFrame {
  ...
  public FileTreeFrame(File directory) {
...
this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
  ...
  public FileTreeFrame(FileSystemModel fileSystemModel,String server) {
    super("JTree FileSystem Viewer - JavaProgrammingForums.com");
    fileDetailsTextArea.setEditable(false);
    //fileSystemModel = new FileSystemModel(directory);
    fileTree = new JTree(fileSystemModel);
  ...
  private String getFileDetails(File file) {
    ...
    buffer.append("Hash Code: " + file.hashCode() + "\n");
    buffer.append("getFreeSpace(): " + file.getFreeSpace() + "\n");
    buffer.append("lastModified(): " + file.lastModified() + "\n");
